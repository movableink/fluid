...
<Story id="components-inputs-fluid-text-input--disabled"/>
...
<Story id="components-inputs-fluid-text-input--has-error"/>
...
<Story id="components-inputs-fluid-text-input--warning"/>
...
<Story id="components-inputs-fluid-text-input--sizes" height="185px" />
